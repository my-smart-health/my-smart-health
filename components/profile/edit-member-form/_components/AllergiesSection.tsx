    ...
    <section>
      <div className="flex flex-col gap-4">
        ...
        <div className="space-y-4">
          {allergies.length === 0 ? (
            <p className="text-gray-500 italic text-sm">No allergies added yet</p>
          ) : (
            allergies.map((allergy, index) => (
              <div key={index} className="p-4 border border-gray-300 rounded-lg space-y-3">
                <div className="flex justify-between items-center">
                  <h4 className="font-semibold text-sm text-gray-600">Allergy #{index + 1}</h4>
                  <button
                    type="button"
                ...
                <input
                  ...
                  placeholder="Allergy Name (e.g., Pollen)"

...
export default function RootLayout({
  ...
  return (
    <html lang="en" data-scroll-behavior="smooth">
      ...
      <body
        className={`${montserrat.variable} antialiased flex flex-col justify-center items-center border min-h-[100dvh] w-auto max-w-xs md:max-w-sm lg:max-w-md mx-auto sm:px-6 lg:px-8 overscroll-none`}
      >
        <Navbar />
        {children}

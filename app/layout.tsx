...
export default async function RootLayout({
  ...
  return (
    <html lang="en" data-scroll-behavior="smooth">
      ...
      <body
        className={`${montserrat.variable} antialiased flex flex-col justify-center items-center pt-4 min-h-[100dvh] w-auto lg:max-w-md mx-auto p-2 overscroll-none border bg-white text-black`}
      >
        <Navbar />
        {children}
